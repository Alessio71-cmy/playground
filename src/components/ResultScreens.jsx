...
import paymentPng from '../assets/results/payment.png'
import scrollPng from '../assets/results/scroll.png'
import stepsPng from '../assets/results/steps.png'
import callPng from '../assets/results/call.png'

const GOLD = '#B8860B'
const GREY = '#D8D8D8'

// Generic badges for the light screens (no illustration asset provided for these yet).
const img1 = (props) => (
...
// Badges from public/immaigni/schermata_1..4 (matched to payment/scroll/steps/call by theme).
const img6 = (props) => (
...
const img9 = (props) => (
  <svg viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <rect x="0.5" y="0.5" width="20" height="20" rx="10" stroke="#B8860B" />
    <g clipPath="url(#clip0_53_263)">
      <path d="M11.6263 12.29L11.9579 13.6507L9.7836 14.5805C9.19457 14.8329 8.9255 15.4501 9.19748 16.149L7.25586 15.4255C7.60782 15.1992 7.85943 14.9576 8.11541 14.6482C8.37138 14.2403 8.62735 13.8355 8.81933 13.3814L9.7676 11.1433C9.88104 10.8755 9.95231 10.6 10.0032 10.3013C10.4744 10.1413 10.8729 9.87958 11.2074 9.47168C11.8837 9.5625 12.4975 9.93499 12.864 10.5507C13.4705 11.5666 13.7934 12.7441 13.821 13.9447C13.8355 14.5789 13.5127 15.0622 12.9731 15.2824L10.3145 16.3675C9.94649 16.5184 9.55235 16.2428 9.43745 15.9119C9.29928 15.5132 9.4709 15.073 9.85341 14.9083L12.0292 13.974C12.4655 13.7877 12.0655 12.6856 11.8343 12.0299C11.7819 12.0145 11.6627 12.0345 11.6438 12.0761C11.6249 12.1177 11.6103 12.2454 11.622 12.2916L11.6263 12.29Z" fill="#B8860B" />
      <path d="M14.6965 8.28776C14.4391 8.55713 14.1089 8.82034 13.7046 8.78186C13.3003 8.74338 12.9716 8.54481 12.7753 8.11536C12.2109 8.30161 11.7005 7.98761 11.6059 7.40269C11.2016 7.28109 10.9253 6.92552 10.9093 6.52686C10.8904 6.07586 11.203 5.79879 11.5739 5.61254C11.6525 5.32162 11.7746 4.99992 12.0059 4.87062C12.2851 4.71362 12.6022 4.73209 12.8887 4.82906C13.0981 4.49812 13.421 4.27647 13.7744 4.23953C14.2064 4.19335 14.5322 4.42424 14.8158 4.74286C15.1488 4.59202 15.4862 4.53968 15.828 4.71362C16.0971 4.84907 16.2673 5.20618 16.3749 5.53712C16.785 5.73722 17.1326 6.03584 17.121 6.5284C17.1093 7.02096 16.7617 7.39345 16.2803 7.49812C16.212 7.84753 16.0244 8.18617 15.7655 8.33086C15.4077 8.53096 15.0688 8.44938 14.6965 8.29238V8.28776Z" fill="#B8860B" />
      <path d="M10.2856 17.5615L9.17298 17.9971C8.73229 18.1695 8.31488 18.1141 7.96728 17.7878C7.66331 17.503 7.50188 17.0058 7.68222 16.5394C7.78403 16.2747 8.02982 16.0238 8.3047 15.9114L13.7616 13.698C14.3259 13.4686 14.9324 13.8611 15.104 14.3829C15.3149 15.0233 15.0051 15.6236 14.4262 15.8637L12.8439 16.5194C12.9864 16.9797 12.9326 17.4383 12.6228 17.7631C12.3305 18.0694 11.9 18.1803 11.4767 18.0186L10.2856 17.56V17.5615Z" fill="#B8860B" />
      <path d="M6.50075 11.3221C6.7829 10.5802 7.2483 10.0399 7.93623 9.74129C8.06567 9.68434 8.2242 9.72128 8.31001 9.83672L7.19449 12.475L7.31957 12.6982C7.3472 12.7474 7.46937 12.6289 7.49264 12.5766L8.65179 9.89521C8.81178 9.52579 9.26409 9.43652 9.55497 9.55812C9.90257 9.70435 10.1469 10.1692 9.97675 10.5786L8.88595 13.2015C8.63143 13.8141 8.28238 14.3806 7.84024 14.8301C7.57554 15.0979 7.23085 15.2226 6.87162 15.1394C6.59964 15.0763 6.30877 14.8285 6.17496 14.4883C5.81136 13.5602 6.12551 12.3211 6.50365 11.3236L6.50075 11.3221Z" fill="#B8860B" />
      <path d="M9.91861 10.9704C9.75426 10.5887 9.4852 10.3255 9.19141 10.2439C8.79727 10.1346 8.43949 10.267 8.10789 10.5687C7.30942 9.90528 7.10581 8.61231 7.72829 7.72416C8.27514 6.94376 9.1725 6.62975 10.0364 6.95453C10.8116 7.24545 11.3788 8.07049 11.3526 9.0002C11.3279 9.88219 10.7694 10.7011 9.91861 10.9704Z" fill="#B8860B" />
      <path d="M8.81726 15.606C8.36203 15.7907 8.06679 16.1293 7.94753 16.6573L5.94483 15.8815C5.38925 15.666 5.08819 15.0472 5.24672 14.5054C5.4227 13.9051 6.02337 13.4972 6.60512 13.7173L10.1655 15.058L8.81726 15.606Z" fill="#B8860B" />
      <path d="M12.2829 8.30418C12.0313 8.39653 11.8073 8.3365 11.6837 8.14564C11.5731 7.97632 11.5746 7.70695 11.7142 7.53917C11.8538 7.37139 12.104 7.31444 12.3163 7.4422C12.4647 7.52993 12.5752 7.71618 12.5723 7.88088C12.5708 8.03481 12.4429 8.24415 12.2814 8.30418H12.2829Z" fill="#B8860B" />
      <path d="M11.1991 8.00668C11.327 7.95896 11.5496 8.05286 11.6019 8.16522C11.6834 8.34224 11.5976 8.54388 11.4463 8.61469C11.295 8.68549 11.0914 8.62392 11.0202 8.47307C10.9402 8.30684 11.01 8.07903 11.2005 8.00668H11.1991Z" fill="#B8860B" />
    </g>
    <defs>
  ...
  return (
    ...
    >
      <img
        ...
        alt=""
        className="magic-in"
        style={{ width: 'clamp(120px, 30dvh, 220px)', height: 'auto', animationDelay: '0ms' }}
      />
      <p
      ...
      <div className="absolute bottom-0 left-0 right-0 flex flex-col items-center pb-4 sm:pb-8">
        <div className="magic-in" style={{ animationDelay: '300ms' }}>
          {subtitle.map((s, i) => (
...
export { SCREENS, LIGHT_SCREENS, ResultScreen, LightResultScreen, img1, img2, img3, img6, img7, img8, img9 }
